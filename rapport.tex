...
Les actions détaillées pour chaque module illustrent les flux essentiels : de la création à la validation, de la préparation à la livraison. Ces spécifications et cette modélisation constituent le socle à partir duquel l'architecture technique et l'implémentation ont été réalisées.
    ...
    \begin{figure}[h]
    \centering
    \IfFileExists{assets/apache-logo.jpg}{
    \includegraphics[width=0.2\textwidth]{assets/apache-logo.jpg}
    }{
    \textit{Logo Apache : fichier assets/apache-logo.jpg non trouvé.}
    }
    ...
    \begin{figure}[H]
    \centering
    \IfFileExists{assets/auth-flow-uml.jpg}{
    \includegraphics[width=0.8\textwidth]{assets/auth-flow-uml.jpg}
    }{
    \textit{Diagramme du flux d'authentification : fichier assets/auth-flow-uml.jpg non trouvé.}
    }
    ...
    \begin{figure}[H]
    \centering
    \IfFileExists{assets/login-screen.jpg}{
    \includegraphics[width=0.35\textwidth]{assets/login-screen.jpg}
    }{
    \textit{Écran de connexion : fichier assets/login-screen.jpg non trouvé.}
    }
    ...
    \includegraphics[width=0.9\textwidth]{assets/login-fail.jpg}
    }{
    ...
    \begin{minipage}[b]{0.45\textwidth}
    \centering
    \IfFileExists{assets/login-success.jpg}{
    \includegraphics[width=0.9\textwidth]{assets/login-success.jpg}
    }{
    \textit{Réussite de connexion : fichier assets/login-success.jpg non trouvé.}
    }
    ...
    \includegraphics[width=0.9\textwidth]{assets/home-screen.jpg}
    }{
    ...
    \includegraphics[width=0.9\textwidth]{assets/drawer-menu.jpg}
    }{
