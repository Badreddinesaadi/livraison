...
J'ai le plaisir de r\'eserver cette page comme signe de ma profonde gratitude \`a tous ceux qui m'ont apport\'e leur aide de pr\`es ou de loin au bon d\'eroulement de ce travail.

Tout d'abord, je remercie Dieu le Tout-Puissant qui m'a donn\'e la d\'etermination et le courage n\'ecessaires pour l'accomplissement de ce travail.

Je tiens \`a exprimer ma profonde gratitude et mon respect \`a mon pr\'ecieux superviseur, M. BOUKSIM Mohcine. J'appr\'ecie sa disponibilit\'e, sa bienveillance, son assistance et ses encouragements. C'est gr\^ace \`a lui que j'ai r\'eussi \`a accomplir ce travail.

Je tiens aussi \`a exprimer ma profonde gratitude \`a mon responsable de fili\`ere, M. TIDHAF Belkasem, pour son d\'evouement et son soutien tout au long de ma trajectoire.

Je tiens \'egalement \`a remercier tous mes enseignants de l'ENSAO pour leur soutien et leur accueil cordial et amical.

Je tiens aussi \`a exprimer ma gratitude envers M. EL ASNAOUI Khalid, membre du jury, pour avoir consenti \`a \'evaluer ce travail. Et pour toutes les raisons, petites et grandes, je ne saurai jamais assez exprimer ma gratitude \`a mes parents pour leur d\'evouement.

Pour finir, je tiens \`a exprimer ma profonde gratitude envers tous ceux qui ont particip\'e \`a la r\'ealisation de ce projet, qu'ils soient proches ou \'eloign\'es. Leur soutien, qu'il soit mat\'eriel, moral ou intellectuel, a \'et\'e d'une valeur inestimable.
...
Pour tout l'amour inconditionnel que vous m'avez t\'emoign\'e, pour votre appui continu et vos encouragements ind\'efectibles. Vous avez \'et\'e ma source de force et d'inspiration tout au long de ce parcours acad\'emique.

Chers parents,

Ce m\'emoire est le r\'esultat de vos efforts et de votre engagement. Vous m'avez toujours soutenu, m\^eme dans les p\'eriodes o\`u je manquais de confiance en moi-m\^eme. Vous m'avez appris la valeur du travail acharn\'e, de la pers\'ev\'erance et de l'int\'egrit\'e.

Votre pr\'ecieuse aide et vos encouragements ont \'et\'e essentiels \`a mon succ\`es. Vous m'avez accompagn\'e et soutenu \`a chaque phase de mon parcours. Gr\^ace \`a votre amour et votre bienveillance, j'ai r\'eussi \`a franchir les obstacles et \`a garder le cap sur mes objectifs.

Je ne pourrai jamais assez vous remercier pour toutes les nuits blanches, les mots d'encouragement et les pri\`eres silencieuses que vous avez offertes pour ma r\'eussite. Vous avez \'et\'e mes premiers guides, mes plus fervents soutiens et mes exemples \`a suivre.

Ce m\'emoire vous est consacr\'e, en t\'emoignage de gratitude pour tout ce que vous avez accompli pour moi. Je souhaite que ce travail illustre les valeurs et les enseignements que vous m'avez partag\'es.
...
\addcontentsline{toc}{section}{{\bfseries Chapitre 3 : Mise en œuvre de la solution}}
    ...
    \textit{Logo Expo : fichier assets/expo-logo.jpg non trouvé.}
    }
    \caption{Expo}
    \label{fig:expo-logo}
    \end{figure}
    ...
    \begin{figure}[ht]
    \centering
    \IfFileExists{assets/android-studio-logo.jpg}{
    \includegraphics[width=0.2\textwidth]{assets/android-studio-logo.jpg}
    }{
    \textit{Logo Android Studio : fichier assets/android-studio-logo.jpg non trouvé.}
    }
    ...
    Ce chapitre a présenté la mise en œuvre concrète de la solution SDK WOOD Mobile. Après avoir exposé les outils de développement (VS Code, Git, GitHub, Postman, phpMyAdmin, Android Studio) et les technologies adoptées (MySQL, PHP, TypeScript, React Native, Expo), l'architecture logicielle a été détaillée : un backend en Transaction Script et un frontend organisé en couches par domaine, avec React Query et Zustand. Le versionnement du code via GitHub a assuré la traçabilité des modifications quotidiennes.

    La réalisation s'est déroulée sur quatre sprints de développement :
    \begin{itemize}[leftmargin=1.2em]
    \item \textbf{Sprint 2} : authentification par jeton et module Voyages.
    \item \textbf{Sprint 3} : module Retours chauffeur et module Rapports qualité.
    \item \textbf{Sprint 4} : module Rotation et module Lieux de projets.
    \item \textbf{Sprint 5} : module Demande de transfert.
    \end{itemize}

    La stratégie de tests manuels, menée conjointement avec Postman pour les API et l'émulateur Android couplé à Expo Go pour le frontend, a permis de valider l'ensemble des fonctionnalités développées.

    L'ensemble de ces six modules, développés selon une approche Scrum itérative, constitue une application mobile complète répondant aux besoins métiers de SDK WOOD.
    ...
    \vspace*{\fill}
    \begin{center}
    {\Huge \textbf{CONCLUSION GÉNÉRALE}}
    \end{center}
    \vspace*{\fill}
    \newpage
