...
\addcontentsline{toc}{section}{{\bfseries Chapitre 3 : Mise en œuvre de la solution}}
    ...
    Ce chapitre a présenté la mise en œuvre concrète de la solution SDK WOOD Mobile. Après avoir exposé les outils de développement (VS Code, Git, GitHub, Postman, phpMyAdmin) et les technologies adoptées (MySQL, PHP, TypeScript, React Native, Expo), l'architecture logicielle a été détaillée : un backend en Transaction Script et un frontend organisé en couches par domaine Le versionnement du code via GitHub a assuré la traçabilité des modifications quotidiennes.
