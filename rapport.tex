    ...
    Le module Voyages permet la création et le suivi des tournées de livraison. Les besoins identifiés sont les suivants :
    \begin{itemize}[leftmargin=1.2em]
    ...
    \item Associer un ou plusieurs bons de livraison (BL) à un voyage.
    \item Consulter la liste des voyages avec filtrage par chauffeur, véhicule, dépôt, ville ou client.
    \item Modifier les informations d'un voyage (chauffeur, véhicule, dépôt, ville).
    \item Clôturer un voyage en enregistrant le kilométrage de retour et la date de retour.
    \item Supprimer un voyage.
    \item Visualiser le détail d'un voyage avec la liste de ses BL et leurs statuts.
    \end{itemize}
